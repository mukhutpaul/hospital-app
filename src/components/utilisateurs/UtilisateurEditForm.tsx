...
import { updateUtilisateur } from "@/app/actions/utilisateurs";
...
export default function UtilisateurEditForm({
  utilisateur,
  roles,
}: Props) {
    ...
    try {
      ...
      const result =
        await updateUtilisateur({
          ...
          /*
           * On envoie le password uniquement
       ...
       * dans le formulaire après modification.
       */
      setFormData((previous) => ({
        ...previous,
        password: "",
